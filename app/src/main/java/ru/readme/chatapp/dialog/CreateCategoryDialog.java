...
public class CreateCategoryDialog {
    ...
    private CreateCategoryDialog(Context context, String parentId, final OnCreateCategoryClickListener listener) {
                ...
                .setPositiveButton(R.string.create, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        if (listener != null) {
                            ...
                            listener.onCreateCategoryClick(cc);
    ...
    public static void show(Context context, String parentId, OnCreateCategoryClickListener listener) {
        CreateCategoryDialog ccd = new CreateCategoryDialog(context, parentId, listener);
        ccd.dialog.show();
    }

    public interface OnCreateCategoryClickListener {
        void onCreateCategoryClick(CreateCategory category);
    }
