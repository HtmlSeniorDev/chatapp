...
import ru.readme.chatapp.fragment.BalanceFragment;
import ru.readme.chatapp.util.SettingsHelper;

public class AnotherBalanceActivity extends AppCompatActivity {
    ...
    private void setupProfileFragment(String id) {
        ...
        getSupportFragmentManager().beginTransaction()
                .replace(R.id.ll_base_layout_content, fragment, MainActivity.TAG_BALANCE)
                .addToBackStack(null)
                .commit();
    }
