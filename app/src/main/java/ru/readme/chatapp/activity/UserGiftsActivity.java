...
import ru.readme.chatapp.fragment.UserGiftsFragment;
import ru.readme.chatapp.util.SettingsHelper;

public class UserGiftsActivity extends AppCompatActivity {
    ...
    private void setupUserGiftsFragment(String id) {
